...
class MyTestCase(unittest.TestCase):
    ...
    def test_register(self):
        with patch('builtins.input', side_effect=["John", "Doe", "john.doe@example.com"]):
            self.student1.register("igho","emmanuel","ighoe571@gmail.com","fatter")
            self.assertTrue(os.path.exists(self.test_file))

    def test_login_success(self):
        with patch('builtins.input', side_effect=["John", "Doe", "john.doe@example.com"]):
            self.student1.register("John", "Doe", "john.doe@example.com","fatter")

        with patch('builtins.input', side_effect=["john.doe@example.com", "Password1."]):
            self.assertTrue(self.student1.login("john.doe@example.com","Password1."))

    def test_login_failure(self):
        with patch('builtins.input', side_effect=["igho", "emmanuel", "ighoe571@gmail.com", "fatter"]):
            self.student1.register("igho", "emmanuel", "ighoe571@gmail.com", "fatter")



        with patch('builtins.input', side_effect=["john.doe@example.com", "WrongPassword"]):
            self.assertFalse(self.student1.login("john.doe@example.com", "wrongPassword"))
    ...
    def test_save_to_file(self):
        ...
        with open(self.test_file, "r") as file:
            content = file.read()
            self.assertIn("John:Doe:john.doe@example.com:", content)
